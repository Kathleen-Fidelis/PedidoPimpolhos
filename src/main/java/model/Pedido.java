...
//	private Integer cod_forma_pagamento;
	...
	public Pedido(String nome_cliente, String cep, String nome_cidade, String nome_rua, Integer numero_casa,
			...
			String valor_frete, String descricao_forma_pagamento, String descricao_status, Boolean flag_endereco) {
		super();
	...
	public Boolean getFlag_endereco() {
		return flag_endereco;
	}



	public void setFlag_endereco(Boolean flag_endereco) {
		this.flag_endereco = flag_endereco;
	}
	...
	public String toString() {
		return "Pedido [cod_pedido=" + cod_pedido + ", nome_cliente=" + nome_cliente + ", cep=" + cep + ", nome_cidade="
				+ nome_cidade + ", nome_rua=" + nome_rua + ", numero_casa=" + numero_casa + ", complemento="
				+ complemento + ", bairro=" + bairro + ", ponto_referencia=" + ponto_referencia + ", descricao_estado="
				+ descricao_estado + ", descricao_frete=" + descricao_frete + ", valor_frete=" + valor_frete
				+ ", descricao_forma_pagamento=" + descricao_forma_pagamento + ", descricao_status=" + descricao_status
				+ ", flag_endereco=" + flag_endereco + "]";
	}
