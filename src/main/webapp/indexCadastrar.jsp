	            ...
	            <div class=" row col-10">
	                ...
	                <div class="bloco2 col-6">
	                   <h2> <img src="imgs/userLogin.png" style="margin-right: 15px;"> Cadastro</h2><br>
	                    ...
	                    <form  method="post" action="ServletCadastroLogin" class="tabela">

	                        <div class="form-group">
                            <label>Nome Completo:</label>
                            <input type="text" name="nome" id="txtuser" value="" class="form-control" required>                              
                        </div>
                        <div class="form-group">
                            <label>Usuário:</label>
                            <input type="text" name="usuario" id="txtuser" value="" class="form-control" required>                              
                        </div>
                        <div class="form-group">
                            <label>Senha:</label>
                            <input type="password" name="senha" id="txtpass" value="" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Confirme Sua Senha:</label>
                            <input type="password" name="senha2" id="txtpass" value="" class="form-control" required>
                        </div>
	                        <%
                               if (conexao != null) {
