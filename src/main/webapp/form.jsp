        ...
        <div class="col-9 conteudo">
         ...
         <c:choose>
			...
			<div class="container mt-5 col-6" style="outline: 1px solid #d5d5d5; border-radius: 11px; padding: 16px;">
				...
				<button style="margin-top: 13px;" class="btn btn-primary" type="submit" name="option" value="insertUsuario">Salvar</button>
				</div>
			</c:when>
			<c:otherwise>
			<div class="container mt-5 col-6" style="outline: 1px solid #d5d5d5; border-radius: 11px; padding: 16px;">
				...
				<button class="btn btn-primary" type="submit" name="option" value="updateUsuario">Atualizar</button>
			</div>
			</c:otherwise>
		</c:choose>
            </form>
