						...
						<c:forEach var="fornecedor" items="${listFornecedor}">
							<tr>
								<form action="ServletFornecedor" method="post">
									...
									<td class="btnAcoes">
<<<<<<< HEAD:Modal e mask/src/main/webapp/indexFornecedor.jsp
										<!-- Button trigger modal -->
									<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-${fornecedor.cod_fornecedor}">Deletar</button>
...
>>>>>>> 8813d85e5b0681e08dd75f4965d096e84602e8c4:src/main/webapp/indexFornecedor.jsp
									<!-- Modal -->
