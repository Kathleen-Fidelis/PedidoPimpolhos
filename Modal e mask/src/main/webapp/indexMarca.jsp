...
<body>
    ...
    <form action="ServletMarca" method="post">
		<button class="btn btn-secondary col-2" style=" margin:0px 0px 35px 18px; font-weight: bold; background-color: #9ACCFF; border: none;" type="submit"  name="optionMarca" value="insertFormMarca"> Adicionar Marca</button>
						...
						<tr>
							 <form action="ServletMarca" method="post"> 
								...
								<!-- Button trigger modal -->
									<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal-${marca.cod_marca}">Deletar</button>
									  ...
									  <div class="modal-dialog">
									    <div class="modal-content">
									      ...
									      <div class="modal-footer">
									        ...
									        <button type="submit" name="optionMarca" value="deleteMarca">Deletar</button>
									      </div>
									    </div>
									  </div>
									</div>
									<button type="submit" name="optionMarca" value="updateFormMarca">Atualizar</button>
								</td>
							</form>	
